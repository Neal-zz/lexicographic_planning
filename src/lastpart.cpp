...
public:
    ...
    void pathHandler(const nav_msgs::Path::ConstPtr& pathMsg) {
        ...
        // 返回 globalPath, searchedPath（局部路径）, remainingPath（局部路径之后的部分）, alternativePaths（rollouts）
